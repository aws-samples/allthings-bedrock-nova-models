...
def nova_canvas_canny_edge_example():
    try:
        ...
        image.save('./images/generated_cannyedge.png')
        print("Generated image saved as: ./images/generated_cannyedge.png")
        
    except Exception as e:
        print(f"Error: {str(e)}")

if __name__ == "__main__":
    nova_canvas_canny_edge_example()
